...
export function ComingSoon() {
    ...
    return (
        <div className="h-screen flex flex-col items-center bg-[#1e1e1e] text-white overflow-hidden">
            ...
            <div className="max-sm:p-6 z-10 p-10 flex justify-center w-full rounded-t-[20px] border-t border-t-[hsla(0,0%,62%,0.62)]" style={{ background: `url(${Noise}), linear-gradient(180deg, rgba(0,0,0,0.55), rgba(0,0,0,0.55)`, backgroundRepeat: 'repeat', backgroundSize: '154px' }}>
